					    ...
					    <!-- checkout-step-02  -->
					  	<div class="panel panel-default checkout-step-02">
						    ...
						    <div id="collapseTwo" class="panel-collapse collapse">
						      <div class="panel-body">
                                <form action="{{ route('billing_information') }}" method="post">
                                    @csrf
                                <div class="col-md-12 contact-form">
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                <label  class="info-title control-label">Country
                                                    <span>*</span>:</label>
                                                <select style="width:290px;"  class="form-control" name="country"  id="country">
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="info-title control-label">City
                                                    <span>*</span>:</label>
                                                <select  style="width:290px;" id="city_list" class="form-control" name="city">
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group">
                                            <label class="info-title" for="exampleInputTitle">Your Address<span>*</span></label>
                                            <input type="address" class="form-control unicase-form-control text-input" id="exampleInputTitle" name="address">
                                          </div>
                                    </div>
                                    <div class="col-md-6">
                                            <div class="form-group">
                                            <label class="info-title" for="exampleInputTitle">Postal/zip<span>*</span></label>
                                            <input type="address" class="form-control unicase-form-control text-input" id="exampleInputTitle" name="postal">
                                          </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                            ...
                                            <textarea name="customermes" class="form-control unicase-form-control" id="exampleInputComments"></textarea>
                                          </div>
                                    </div>
