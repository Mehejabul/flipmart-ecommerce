    ...
    <div class="col-12">
        <div class="card border border-primary">
            <div class="card-header bg-transparent border-primary d-flex justify-content-between">
                <h5 class="my-0 text-primary align-middle"><i class="mdi mdi-bullseye-arrow me-3"></i>All Cupons </h5>
                <a href="{{ route('cupon.create') }}" class="btn btn-sm btn-primary waves-effect waves-light">
                    <i class="bx bx-list-plus font-size-20 align-middle me-2"></i> Create Cupon
                </a>
            </div>
            <div class="card-body">
                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                    ...
                    <tbody class="text-center">
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1" style="">
                                        <li>
                                            <a class="dropdown-item" href="{{ route('cupon.show',$data->cupon_slug) }}"
                                             <i class="dripicons-eye"></i>view</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="{{ route('cupon.edit',$data->cupon_slug) }}">
                                                <i class="bx bx-edit-alt"></i>Edite</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item  btn-link delete-modal" href="#"
                                                data-bs-toggle="modal" data-value="" data-bs-target="#deleteModal{{ $data->cupon_slug }}"> <i
                        ...
                        {{--  Modal  --}}
                        <div class="modal fade" id="deleteModal{{ $data->cupon_slug }}" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <a type="submit" href="{{ route('cupon.softdelete', $data->cupon_slug) }}" class="btn btn-danger" name="delete_data">Yes,
                                            delete it
                                        </a>
