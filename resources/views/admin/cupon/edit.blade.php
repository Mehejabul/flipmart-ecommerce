    ...
    <div class="col-12">
        <div class="card border border-primary">
            <div class="card-header bg-transparent border-primary d-flex justify-content-between">
                <h5 class="my-0 text-primary align-middle"><i class="mdi mdi-bullseye-arrow me-3"></i> Edit Cupon </h5>
                <a href="{{ route('cupon.index') }}" class="btn btn-sm btn-primary waves-effect waves-light">
                    <i class="bx bx-list-plus font-size-20 align-middle me-2"></i> All Cupon
                </a>
            </div>
            <div class="card-body">
                ...
                @endif
                <form method="POST" action="{{ route('cupon.update',$data->cupon_slug) }}" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="row">
                        <div class="col-lg-6 my-2">
                            <div class="form-group" {{$errors->has('cupon_title') ? ' has-error':''}}>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="cupon_title" value="{{ $data->cupon_title }}">
                                </div>
                            ...
                            <div class="form-group" {{$errors->has('cupon_starting') ? ' has-error':''}}>
                                <div class="mb-3">
                                    <label class="form-label"><strong class="text-primary">Cupon starting<span
                                                class="text-danger">*</span>:</strong></label>
                                    <input type="date" class="form-control" name="cupon_starting" value="{{ $data->cupon_starting}}">
                                </div>
                            ...
                            <div class="form-group" {{$errors->has('cupon_ending') ? ' has-error':''}}>
                                <div class="mb-3">
                                    <label class="form-label"><strong class="text-primary">Cupon Ending<span
                                                class="text-danger">*</span>:</strong></label>
                                    <input type="date" class="form-control" name="cupon_ending" value="{{ $data->cupon_ending }}">
                                </div>
                        ...
                        <div class="col-lg-12 my-2">
                            <div class="form-group" {{$errors->has('cupon_remarks') ? ' has-error':''}}>
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control" name="cupon_remarks" value="{{ $data->cupon_remarks }}"></textarea>
                                </div>
