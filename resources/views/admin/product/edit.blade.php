    ...
    <div class="col-12">
        <div class="card border border-primary">
            <div class="card-header bg-transparent border-primary d-flex justify-content-between">
                <h5 class="my-0 text-primary align-middle"><i class="mdi mdi-bullseye-arrow me-3"></i>Edite Product
                </h5>
                            ...
                            <div class="form-group" {{$errors->has('pro_cate_id') ? ' has-error':''}}>
                                <div class="mb-3">
                                    ...
                                    <select type="number" class="form-control" name="pro_cate_id"
                                        id="pro_cate_id" value="{{ $data->pro_cate_id }}">
                                    ...
                                    <div class="form-group" {{$errors->has('product_image') ? ' has-error':''}}>
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="product_image_input" class="form-control"
                                                name="product_image" value="{{$data->product_image}}">
                                        </div>
