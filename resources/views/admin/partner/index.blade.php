                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            <td>
                                ...
                                <img id="partner_image_preview" src="{{ asset('uploads/partner/'.$data->partner_image) }}" width="50px">
                                @else
                                <img id="partner_image_preview" src="{{ asset('uploads/no-entry.png') }} " width="50px">
                                @endif
                            </td>
                        ...
                        {{--  Modal  --}}
                        <div class="modal fade" id="deleteModal{{ $data->partner_slug }}" data-bs-backdrop="static"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <a type="submit" href="{{ route('partner.softdelete', $data->partner_slug) }}"
