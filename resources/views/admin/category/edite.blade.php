    ...
    <div class="col-12">
        <div class="card border border-primary">
            ...
            <div class="card-body">
                ...
                @endif
                <form method="POST" action="{{ route('product.category.update', $category_data->pro_cate_slug) }}" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="row">
                            ...
                            <div class="form-group" {{$errors->has('pro_cate_name') ? ' has-error':''}}>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="pro_cate_name"
                                        value="{{ $category_data->pro_cate_name }}">
                                </div>
                            ...
                            <div class="form-group" {{$errors->has('pro_cate_parent') ? ' has-error':''}}>
                                <div class="mb-3">
                                    ...
                                    <select type="number" class="form-control" name="pro_cate_parent"
                                        id="pro_cate_parent" value="{{ $category_data->pro_cate_parent }}">
                            ...
                            <div class="form-group" {{$errors->has('pro_cate_order') ? ' has-error':''}}>
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" name="pro_cate_order"
                                        value="{{ $category_data->pro_cate_order }}">
                                </div>
                        ...
                        <div class="col-lg-6  my-2">
                            <div class="row">
                                ...
                                <div class="col-md-4 my-2 d-flex">
                                    @if ($category_data->pro_cate_icon)
                                    <img id="category_image_preview" style="width: 100px" class="m-auto" src="{{ asset('uploads/category/icon/'.$category_data->pro_cate_icon) }}" alt="Category Image">
                                    @else
                        ...
                        <div class="col-lg-12  my-2">
                            <div class="row">
                                ...
                                <div class="col-md-4 my-2 d-flex">
                                    @if ($category_data->pro_cate_image)
                                    <img id="category_image_preview" style="width: 100px" class="m-auto" src="{{ asset('uploads/category/image/'.$category_data->pro_cate_image) }}" alt="Category Image">
                                    @else
                                    <img id="category_image_preview" style="width: 100px" class="m-auto" src="{{ asset('uploads/no-entry.png') }}" alt="Category Image">
                                    @endif
                                </div>
